...
async function main() {
    ...
    // Create signs one by one or createMany
    await prisma.trafficSign.createMany({ data: signs })

    // 4. Seed Topics & Questions
    const topics = [
        {
            ...
            questions: [
                ...
                { q: 'What is the legal blood alcohol limit for drivers?', opts: [{ t: '0.08%', c: true }, { t: '0.00%', c: false }, { t: '0.05%', c: false }, { t: '0.10%', c: false }] },
                ...
                { q: 'What should you do when an ambulance approaches with sirens?', opts: [{ t: 'Pull over and stop', c: true }, { t: 'Speed up', c: false }, { t: 'Ignore it', c: false }, { t: 'Honk', c: false }] },
            ]
        },
        {
